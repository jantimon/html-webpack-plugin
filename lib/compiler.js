...
/**
 * Clear child compilation promise for main compiler
 *
 * @param {WebpackCompiler} mainCompiler
 */
...
/**
 * Adds child compilation file dependencies to main compilation file dependencies
 * @param {WebpackCompilation} mainCompilation
 */
function injectFileDependencies (mainCompilation) {
  const childCompiler = getChildCompiler(mainCompilation.compiler);
  childCompiler.fileDependencies.forEach(fileDependency => {

 ...
 * [html-webpack-partials-plugin](https://github.com/colbyfayock/html-webpack-partials-plugin) to easily manage partials (such as HTML) without a custom template

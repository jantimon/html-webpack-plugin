...
const getHtmlWebpackPluginHooks = require('./hooks.js').getHtmlWebpackPluginHooks;
...
class multiHtmlWebpackPlugin {
    constructor(htmlWebpackPlugins, compiler) {
        ...
        this.logger = log({ name: 'HtmlWebpackPlugin' })

        this.apply(compiler);
    }

    apply(compiler) {
        this.logger.info('multiHtmlWebpackPlugin apply has been called')

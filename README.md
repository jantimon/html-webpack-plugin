 ...
 * [html-webpack-injector](https://github.com/architgarg/html-webpack-injector) to inject chunks in `head` or `body` (different locations ) of same html document with async and defer support.

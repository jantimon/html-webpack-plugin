 ...
 * [preload-webpack-plugin](https://github.com/vuejs/preload-webpack-plugin) for automatically wiring up asynchronous (and other types) of JavaScript chunks using `<link rel='preload'>` helping with lazy-loading
